...
export default async function main(client:any){
  const code=new Uint8Array(readFileSync(path.resolve(process.cwd(),"contracts/ReleaseAuthority.py")));
  ...
  console.log(JSON.stringify({name:"ReleaseAuthority",hash,receipt},null,2));
}
